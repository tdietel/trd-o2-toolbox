...
find_library(AliceO2_LIBRARY_TRDRECONSTRUCTION NAMES O2TRDReconstruction HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)

set(AliceO2_LIBRARIES
  ${AliceO2_LIBRARY_HEADERS}
  ${AliceO2_LIBRARY_FRAMEWORK}
  ${AliceO2_LIBRARY_TRDRECONSTRUCTION}
)
...
if(${ALICEO2_FOUND})
    ...
    if(NOT TARGET AliceO2::TRDReconstruction)
        add_library(AliceO2::TRDReconstruction INTERFACE IMPORTED)
        set_target_properties(AliceO2::TRDReconstruction PROPERTIES
          INTERFACE_INCLUDE_DIRECTORIES "${AliceO2_INCLUDE_DIRS}"
          INTERFACE_LINK_LIBRARIES "${AliceO2_LIBRARY_TRDRECONSTRUCTION}"
        )
    endif()
